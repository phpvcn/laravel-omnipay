...
'providers' => [
	...
	'Phpvcn\LaravelOmnipay\LaravelOmnipayServiceProvider',
...
```php
	'Omnipay' => 'Phpvcn\LaravelOmnipay\Facades\OmnipayFacade',
```

Finally, publish the configuration files:

```
php artisan vendor:publish --provider="Phpvcn\LaravelOmnipay\LaravelOmnipayServiceProvider" --tag=config
```
...
```php
$app->register(Phpvcn\LaravelOmnipay\LumenOmnipayServiceProvider::class);
```
